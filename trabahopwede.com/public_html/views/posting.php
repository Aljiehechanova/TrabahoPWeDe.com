...
<head>
  <meta charset="UTF-8">
  <title>Posting - Trabaho PWeDe</title>
  ...
  <style>
    ...
    .posting-card h3 { color: #FFD700; }
    .posting-card label { color: #FFD700; }
    .btn-custom {
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-lg-none">
        ...
        <li class="nav-item"><a class="nav-link active" href="posting.php"><i class="bi bi-plus-circle"></i> Posting</a></li>
...
<div id="sidebar" class="d-none d-lg-block">
  <nav>
    <ul>
      ...
      <li><a href="posting.php" class="active"><i class="bi bi-plus-circle"></i> Posting</a></li>
...
<div class="main-content">
  <div class="posting-card">
    <h3 class="mb-4">Create a Job Posting</h3>
    <form method="POST" action="save_posting.php">
      <div class="mb-3">
        <label for="job_title" class="form-label">Job Title</label>
        <input type="text" name="job_title" id="job_title" class="form-control" required>
      </div>
      <div class="mb-3">
        <label for="skills_requirement" class="form-label">Skills Requirement</label>
        <input type="text" name="skills_requirement" id="skills_requirement" class="form-control" required>
      </div>
      <div class="mb-3">
        <label for="disability_requirement" class="form-label">Disability Requirement</label>
        <input type="text" name="disability_requirement" id="disability_requirement" class="form-control">
      </div>
      <div class="mb-3">
        <label for="job_description" class="form-label">Job Description</label>
        <textarea name="job_description" id="job_description" rows="5" class="form-control"></textarea>
      </div>
