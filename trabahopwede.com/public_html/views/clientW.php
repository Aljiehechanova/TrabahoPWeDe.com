...
<head>
  <meta charset="UTF-8">
  <title>Client Workshops - Trabaho PWeDe</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-lg-none">
        ...
        <li class="nav-item"><a class="nav-link active" href="clientW.php"><i class="bi bi-easel"></i> Workshops</a></li>
...
<div id="sidebar" class="d-none d-lg-block">
  <nav>
    <ul>
      ...
      <li><a href="clientW.php" class="active"><i class="bi bi-easel"></i> Workshops</a></li>
...
<div class="main-content">
  <h1 class="fw-bold text-dark">Workshops</h1>
  <p>This is your Workshops page. Add your workshop listing or management features here.</p>
</div>
